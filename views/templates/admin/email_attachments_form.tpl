...
<form id="emailAttachementsManager" class="defaultForm form-horizontal" action="{$form_action}" method="POST" enctype="multipart/form-data" novalidate>
    ...
    <div class="panel">
        <div class="panel-heading">
            ...
            {l s='Email content inclusion' mod='ps_legalcompliance'}
        </div>
        <p>
            {l s='This section allows you to include information from the "Legal Content Management" section above at the bottom of your shop\'s emails.' mod='ps_legalcompliance'}
        </p>
        <p>
            {l s='For each type of email, you can define which content you would like to include.' mod='ps_legalcompliance'}
        </p>
        <br/>
                ...
                <tr>
                    <th>
                        <span class="title_box">
                            ...
                            {l s='Email templates' mod='ps_legalcompliance'}
                        </span>
